...
**Answer** It shows us all the NBA players  who played last season (plus who they played for) and all of their stats that basketball reference tracks
...
**Answer** Grouping each player by position and saying how many players were each position (or in cases of playing multiple, which two they played.) There are more shooting guards than any other position, according to basketball reference.
...
**Answer** There are some players that play multiple positions, and the positions are sometimes meaningless labels that don't accurately reflect their behaviors
...
I think the PF position is most interesting because it might be the least definable, but they still have the highest average minutes among players listed as only one position (the multi-position players are all super small sample size). What does the minute distributions tell us about the optimal roster construction in terms of depth at each position?
